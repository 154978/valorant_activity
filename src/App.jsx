  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-red-600 selection:text-white">
      ...
      <nav className="flex justify-between items-center 
                     px-6 py-5 md:px-16 bg-black border-b border-zinc-800 top-0 z-50">
      ...
      <section className="relative bg-zinc-950 px-6 md:px-16 py-24 
        ...
        <div>
          <span className="inline-block bg-red-500/10
                           text-red-500 text-xs font-bold uppercase tracking-widest px-4 py-1 
      ...
      <section className="bg-black px-6 md:px-16 py-10 grid 
                           grid-cols-2 md:grid-cols-4 gap-6 text-center border-b border-zinc-800">
